...
export const CartNavigation = () => {
  ...
  return (
    <div>
      <nav class="Navigation-container fixed">
        <div>
        ...
        <div>
          <ul className="nav-links links">
            <Link to="/cart" className="text-decoration-none link color-link">
              <li class="cart">
                <svg
                  style={{ height: "1.5rem" }}
                  aria-hidden="true"
                ...
                <span class="icon-badge  badge-align badge-color">{cartItems.length}</span>
              </li>
            </Link>
            <Link to="/wishlist" className="text-decoration-none link color-link">
              <li class="heart">
                <svg
                  style={{ height: "1.5rem" }}
                  aria-hidden="true"
                ...
                <span class="icon-badge  badge-align badge-color">{wishList.length}</span>
              </li>
            </Link>
            <Link
              style={{ color: "white" }}
